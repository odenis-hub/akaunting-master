...
class EmptyPage extends Component
{
    ...
    protected function getImage($page, $image)
    {
        ...
        if (! empty($this->imageEmptyPage)) {
            $imageEmptyPage = $this->imageEmptyPage;
            if (str_starts_with($imageEmptyPage, "public/")) {
                $imageEmptyPage = substr($imageEmptyPage, strlen("public/"));
            }

            return asset($imageEmptyPage);
        }
